...
const HomePage = (props) => {
    ...
    return (
        <div style={{ marginTop: '90px' }}>
            ...
            <div style={{ display: 'flex', position: "sticky", width: '100%', bottom: 30, justifyContent: 'flex-end' }} >
                <Image onClick={displayLoginComponent} className="admin_btn" src="/images/developer.png" alt="Admin" />
                <div style={{ height: '250px', width: '200px', display: `${show === false ? 'none' : ''}` }}>
                    <LoginComponent />
                </div>
            </div>
        </div>
